...
[![Live Demo](https://img.shields.io/badge/🚀_เข้าใช้งานเว็บไซต์-Live_Demo-0284c7?style=for-the-badge&logo=vercel&logoColor=white)](https://school-library-system.vercel.app)
...
> 🌐 **ลิงก์เข้าสู่เว็บไซต์ใช้งานจริง (Live Website):** **[https://school-library-system.vercel.app](https://school-library-system.vercel.app)**  
> 🔗 **ลิงก์สำรอง (Backup Domain):** [https://school-library-system-m8nn.vercel.app](https://school-library-system-m8nn.vercel.app)

---

เว็บแอปพลิเคชันระบบบริหารจัดการห้องสมุดโรงเรียนแบบอัตโนมัติ พัฒนาด้วย **Next.js 14+ (App Router)** ร่วมกับ **Tailwind CSS** และ **TypeScript** ในธีมสี **น้ำเงิน-ฟ้า (Modern Blue & Sky Palette)** ออกแบบ Responsive รองรับการแสดงผลทุกหน้าจออย่างสมบูรณ์แบบทั้ง สมาร์ตโฟน (โทรศัพท์มือถือ), แท็บเล็ต/ไอแพด, และคอมพิวเตอร์ตั้งโต๊ะ/โน้ตบุ๊ก
