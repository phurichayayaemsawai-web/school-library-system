          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/80 space-y-3">
                <h3 className="text-xs font-bold text-slate-700 flex items-center gap-1.5">
                  ...
                  <span>ตัวอย่างภาพปก (Preview)</span>
                </h3>

                <div className="aspect-[3/4] rounded-xl overflow-hidden bg-slate-100 shadow-inner border border-slate-200 flex items-center justify-center relative">
                  {coverUrl && !imageError ? (
                    <img
                      src={coverUrl}
                      alt="Cover Preview"
                ...
                <div className="p-3 bg-sky-50/70 border border-sky-200/80 rounded-xl text-[11px] text-slate-600 space-y-1">
                  ...
                  <ol className="list-decimal list-inside space-y-0.5 text-slate-500">
                    ...
                    <li>เลือก <span className="font-medium text-slate-700">"คัดลอกที่อยู่รูปภาพ"</span> (Copy Image Address)</li>
            ...
            <div className="md:col-span-2 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                ...
                {/* Cover URL */}
                <div className="sm:col-span-2 p-3 bg-sky-50/50 border border-sky-200 rounded-2xl space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-white border border-sky-300 rounded-xl text-xs font-medium focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  />
